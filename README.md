...
# Обо мне
С детства разбираю всё, что работает на электричестве: от смартфонов до нейросетей. Мне важно понимать системы изнутри, поэтому программирование для меня — это в первую очередь инструмент созидания.

Веду свой сайт, контрибьючу в open-source и развиваю ReMind (мой AI-проект). Верю, что знания должны быть открытыми, поэтому делюсь гайдами и кодом на GitHub. Сейчас учусь в физмат-лицее и участвую в инженерных проектах.

Стараюсь соблюдать баланс и не выгорать — это бывает непросто, но я учусь. В свободное время играю на гитаре или залипаю в «умные» игры: Portal, The Stanley Parable, Antichamber. Ценю атмосферный звук (ambient, synth-pop) — он помогает сфокусироваться.

Всегда открыт для общения и обмена идеями.
